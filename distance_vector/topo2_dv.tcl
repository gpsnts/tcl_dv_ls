...
set nf [open topologia2_distance_vector.nam w]
$ns namtrace-all $nf

# Opens created file
set f [open topologia2_distance_vector.tr w]
$ns trace-all $f
...
set f0 [open topologia2_distance_vector0.tr w]
set f1 [open topologia2_distance_vector1.tr w]
set f2 [open topologia2_distance_vector2.tr w]
