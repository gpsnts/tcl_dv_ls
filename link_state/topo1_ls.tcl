...
proc finish {} {
  ...
  # exec nam topologia1_link_state.nam &
...
set nf [open topologia1_link_state.nam w]
$ns namtrace-all $nf

# Opens created file
set f [open topologia1_link_state.tr w]
$ns trace-all $f
...
set f0 [open topologia1_link_state0.tr w]
set f1 [open topologia1_link_state1.tr w]
set f2 [open topologia1_link_state2.tr w]
